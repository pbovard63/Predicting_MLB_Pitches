'''
This file contains functions that utilize classification and regression functions in conjunction to predict pitch type and location of an MLB pitch.  Utilizes pitch type counts in the last 10 pitches the pitcher has thrown as classification features.
'''
