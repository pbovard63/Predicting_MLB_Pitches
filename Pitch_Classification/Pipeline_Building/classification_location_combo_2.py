'''
This file contains functions that utilize classification and regression functions in conjunction to predict pitch type and location of an MLB pitch.  Utilizes pitch type counts in the last 100 pitches the pitcher has thrown as classification features.
'''
...
def random_forest_pitch_classification(train_df, val_df):
    ...
    rf_cols = ['Cluster','inning', 'top', 'on_1b', 'on_2b', 'on_3b', 'b_count', 's_count', 'outs', 'stand_R', 
       ...
       'last_100_cu', 'last_100_si', 'last_100_fc', 'last_100_kc', 'last_100_fs',
       'last_100_kn', 'last_100_ep', 'last_100_fo', 'last_100_sc']
